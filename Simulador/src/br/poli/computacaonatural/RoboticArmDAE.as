package br.poli.computacaonatural {
	 ...
	 */
	public class RoboticArmDAE extends Sprite {
		...
		public function RoboticArmDAE(config:String = "data/config.xml") {
			this.objects = new Vector.<ElementModel>();
			this.pegou = false;
			this.urlCollada = "models/robo8.DAE";
			this.urlConfig = config;
			
//			this.urlCollada = "models/braco.DAE";
		...
		private function initObjects():void {
			...
			*/
			...
			collada.scaling = 30
			collada.material = new WireColorMaterial(0xffcccc);
			collada.shading = true
		...
		private function onLoadCollada(e:Loader3DEvent):void {
			...
			this.mao = bracoConteiner.getChildByName ("parte5") as Mesh;
			 
			this.pGeral = bracoConteiner.getChildByName ("parte4") as Mesh;
			
			this.pJuncao1 = bracoConteiner.getChildByName ("anti") as Mesh;
